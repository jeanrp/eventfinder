...
namespace EventFinder.Infra.Data.Migrations
{
    ...
    [Migration("20171115133925_ChavesEstrangeirasEnderecoEmpresaEvento")]
    partial class ChavesEstrangeirasEnderecoEmpresaEvento
    {
            ...
            modelBuilder.Entity("EventFinder.Domain.Empresas.Empresa", b =>
                {
                    b.HasOne("EventFinder.Domain.Eventos.Endereco", "Endereco")
                        .WithOne("Empresa")
                        .HasForeignKey("EventFinder.Domain.Empresas.Empresa", "EnderecoId");
                });
            ...
            modelBuilder.Entity("EventFinder.Domain.Eventos.Evento", b =>
                {
                    ...
                    b.HasOne("EventFinder.Domain.Eventos.Endereco", "Endereco")
                        .WithOne("Evento")
                        .HasForeignKey("EventFinder.Domain.Eventos.Evento", "EnderecoId")
